    ...
    def load_translations(self):
        ...
        return {
            "ko": {
                ...
                "unblock_friend_dialog_title": "차단 해제 창",
                "unblock_friend_input_label": "차단 해제할 유저의 ID를 입력하세요:",
                "unblock_friend_button": "차단 해제",
                "unblock_friend_warning": "차단 해제할 ID를 입력해주세요.",
                ...
                "block_friend_dialog_title": "차단 창",
                "block_friend_input_label": "차단할 친구의 ID를 입력하세요:",
                "block_friend_button": "차단",
                "block_friend_warning": "차단할 ID를 입력해주세요.",
            ...
            "en": {
                ...
                "unblock_friend_dialog_title": "Unblock Dialog",
                "unblock_friend_input_label": "Enter the ID to unblock user:",
                "unblock_friend_button": "Unblock",
                "unblock_friend_warning": "Please enter the ID to unblock a user.",
            ...
            "jp": {
                ...
                "unblock_friend_dialog_title": "ブロック解除ダイアログ",
                "unblock_friend_input_label": "ブロック解除するIDを入力してください:",
                "unblock_friend_button": "ブロックを解除",
                "unblock_friend_warning": "ブロック解除するIDを入力してください。",
